...
sourceModelDirectory = data_folder + "Skull_Surfaces_sources_essai"  # Directory that contains the mesh models used to train the labels predictions 
targetModelDirectory = data_folder + "Skull_Surfaces_essai"  # Directory that contains the mesh to be landmark-projected
...
for sourceFile in os.listdir(sourceModelDirectory):
    ...
    for targetFile in os.listdir(targetModelDirectory):
        ...
        outputDirectory= f"{data_folder}/output_alpaca_classique/"#folder that will receive the predicted landmarks files 
        ...
        print ("PRINT ORIGINAL LANDMARKS ON SLICER")
